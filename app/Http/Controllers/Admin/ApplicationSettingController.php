...
class ApplicationSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($id == -1){
            ...
            $applicationSetting->run_by = $request->run_by;
            $applicationSetting->recognized = $request->recognized;
            $applicationSetting->approved = $request->approved;
            $applicationSetting->affilated = $request->affilated;
            
            $applicationSetting->address = $request->address;
            $applicationSetting->email = $request->email;
            $applicationSetting->contact_no_first = $request->contact_no_first;
            $applicationSetting->contact_no_second = $request->contact_no_second;
            ...
            $applicationSetting->logo_left = $this->uploadImage($request, 'logo_left', $this->path, 200, 200);
            $applicationSetting->logo_right = $this->uploadImage($request, 'logo_right', $this->path, 200, 200);
            ...
            $applicationSetting->footer_center = $request->footer_center;
            $applicationSetting->footer_right = $request->footer_right;
            $applicationSetting->logo_left = $this->updateImage($request, 'logo_left', $this->path, 200, 200, $applicationSetting, 'logo_left');
            $applicationSetting->logo_right = $this->updateImage($request, 'logo_right', $this->path, 200, 200, $applicationSetting, 'logo_right');
