...
class ReceiptSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($id == -1){
            ...
            $printSetting->logo_left = $this->uploadImage($request, 'logo_left', $this->path, 180, 180);
            $printSetting->logo_right = $this->uploadImage($request, 'logo_right', $this->path, 180, 180);
            ...
            $printSetting->footer_center = $request->footer_center;
            $printSetting->footer_right = $request->footer_right;
            $printSetting->logo_left = $this->updateImage($request, 'logo_left', $this->path, 180, 180, $printSetting, 'logo_left');
            $printSetting->logo_right = $this->updateImage($request, 'logo_right', $this->path, 180, 180, $printSetting, 'logo_right');
