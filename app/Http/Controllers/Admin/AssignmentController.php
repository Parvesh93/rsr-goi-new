...
use App\Imports\AssignmentMarksImport;
...
class AssignmentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:'.$this->access.'-marking', ['only' => ['show','marking','import','export']]);
    }
    ...
    */
    public function export($id)
    {
        ...
        return Excel::download(new AssignmentMarksExport($data), Str::slug($assignment->title ?? '').'_assignment.xlsx');
    }
    ...
    */
    public function import(Request $request)
    {
        ...
        //
        Excel::import(new AssignmentMarksImport($data), $request->file('import'));
