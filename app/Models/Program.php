...
class Program extends Model
{
    ...
    {
        return $this->hasMany(OldStudent::class, 'program_id', 'id');
    }

     public function sharans()
    {
        return $this->hasMany(Sharan::class, 'program_id', 'id');
    }
     public function bilashs()
    {
        return $this->hasMany(Bilash::class, 'program_id', 'id');
    }

     public function kanchans()
    {
        return $this->hasMany(Kanchan::class, 'program_id', 'id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\User', 'user_program', 'program_id', 'user_id');
    }
