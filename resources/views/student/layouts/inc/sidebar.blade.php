...
<div class="navbar-content scroll-div ps ps--active-y">
    <ul class="nav pcoded-inner-navbar">
        ...
        <!--@if(panel('student_fees_id')->status == 1)-->
        <!--<li class="nav-item {{ Request::is('student/fees-student-quick-upload*') ? 'active' : '' }}">-->
        <!--    <a href="{{ route('student.fees-student.quick.upload') }}" class="nav-link">-->
        <!--        <span class="pcoded-micon"><i class="fas fa-money-bill-wave"></i></span>-->
        <!--        <span class="pcoded-mtext">{{ trans_choice('module_fees_upload', 2) }}</span>-->
        <!--    </a>-->
        <!--</li>-->
        <!--@endif-->
