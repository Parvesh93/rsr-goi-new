        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="needs-validation" novalidate action="{{ route($route.'.quick.upload.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="fee_amount" id="fee_amount" value="{{ old('fee_amount') ?? 0 }}"  required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="discount_amount" id="discount_amount" value="{{ old('discount_amount') ?? 0 }}"  required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="fine_amount" id="fine_amount" value="{{ old('fine_amount') ?? 0 }}"  required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control autonumber" name="paid_amount" id="paid_amount" value="{{ old('paid_amount') ?? 0 }}"  required>
                        ...
                        <div class="form-group col-md-12">
                            <label for="fine_amount" class="form-label">{{ __('field_reciept') }}<span>*</span></label>
                            <input type="file" class="form-control autonumber" name="attach" id="attach" value="{{ old('attach') ?? 0 }}"  required>

                            <div class="invalid-feedback">
                              {{ __('required_field') }} {{ __('field_reciept') }}
                            </div>
                        </div>
