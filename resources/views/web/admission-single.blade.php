...
@section('title', __('navbar_admission'))
@section('content')
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="slider-content s-slider-content mt-120">
                                        <h2 data-animation="fadeInUp" data-delay=".4s">{{ $admission1->title }}</h2>
                                        <p data-animation="fadeInUp" data-delay=".6s">{!! 'Home / '.$admission1->title !!}</p>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                @isset($admissions)
                                    @foreach ($admissions as $admission)
                                        <li class="course-tab-item {{ request()->slug == $admission->slug ? 'active' : '' }}">
                                            <a class=""
