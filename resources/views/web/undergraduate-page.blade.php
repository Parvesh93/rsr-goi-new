                ...
                <div class="row">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                @isset($pages)
                                    @foreach ($pages as $page)
                                        <li class="about-tab-item">
                                            <a class=""
                                                href="{{ route('inter.single', ['slug' => $page->slug]) }}">{{ $page->title }}
                                            </a>
                                        </li>
                                    @endforeach
                                @endisset
                        ...
                        <ul class="labs-tabs d-none d-md-flex">
                            @foreach ($pages as $page)
                                <li class="labs-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                    <a class="mri"
                                        href="{{ route('inter.single', ['slug' => $page->slug]) }}">{{ $page->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="labs-content">
                            <!-- Labs Overview Tab -->
                            <div class="labs-tab-content active" id="inter-over">
                                {!! $page1->description !!}
                            </div>
