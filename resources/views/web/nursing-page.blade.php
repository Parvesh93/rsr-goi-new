                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <li class="nav-item dropdown labs-tabs-mobile d-md-none">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                @if (request()->slug == 'ram-sharan-roy-college-nursing-jandaha')
                                    @isset($pages)
                                        @foreach ($pages as $page)
                                        <li class="about-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                            <a class=""
                                                href="{{ route('nursing.single', ['slug' => $page->slug]) }}">{{ $page->title }}</a>
                                        </li>
                                        @endforeach
                                    @endisset
                                @elseif (request()->slug == 'rbsrdr-college-nursing-hajipur')
                                    @isset($pages)
                                        @foreach ($pages as $page)
                                        <li class="about-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                            <a class=""
                                                href="{{ route('rbs.single', ['slug' => $page->slug]) }}">{{ $page->title }}</a>
                                        </li>
                                        @endforeach
                                    @endisset
