...
@section('title', __('engineering_us'))
@section('content')
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                @isset($pages)
                                    @foreach ($pages as $page)
                                        <li class="course-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                            <a class=""
                                                href="{{ route('rsr.single', ['slug' => $page->slug]) }}">{{ $page->title }}
                                            </a>
                                        </li>
                                    @endforeach
                                @endisset
                            ...
                            @isset($pages)
                                @foreach ($pages as $page)
                                    <li class="labs-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                        <a class="mri"
                                            href="{{ route('rsr.single', ['slug' => $page->slug]) }}">{{ $page->title }}</a>
                                    </li>
                                @endforeach
                            @endisset
