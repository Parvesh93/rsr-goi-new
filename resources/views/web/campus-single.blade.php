                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="slider-content s-slider-content mt-120">
                                    <h2 data-animation="fadeInUp" data-delay=".4s">{{ $campus1->title }}</h2>
                                    <p data-animation="fadeInUp" data-delay=".6s">{!! 'Home / '.$campus1->title !!}</p>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                @isset($campuses)
                                    @foreach ($campuses as $campus)
                                        <li class="course-tab-item {{ request()->slug == $campus->slug ? 'active' : '' }}">
                                            <a class=""
                            ...
                            @isset($campuses)
                                @foreach ($campuses as $campus)
                                    <li class="campus-tab-item {{ request()->slug == $campus->slug ? 'active' : '' }}">
                                        <a class="mri"
                                            href="{{ route('campus.single', ['slug' => $campus->slug]) }}">{{ $campus->title }}</a>
                                    </li>
                                @endforeach
