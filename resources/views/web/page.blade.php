                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="campusDropdown">
                                ...
                                @foreach ($pages as $page)
                                    <li class="about-tab-item {{ request()->slug == $page->slug ? 'active' : '' }}">
                                        <a class=""
                                            href="{{ route('page.single', ['slug' => $page->slug]) }}">{{ $page->title }}</a>
                                    </li>
                                @endforeach
                            @endisset
                        ...
                        <div class="d-none d-lg-block">
                            ...
                            <!--        <li><a href="#iti">ITI</a></li>-->
                            <!--        <li><a href="#intermediate-in-commerce">Intermediate In Commerce</a></li>-->
                            <!--        <li><a href="#intermediate-in-Arts">Intermediate In Arts</a></li>-->
                            <!--        <li><a href="#intermediate-in-science">Intermediate In Science</a></li>-->
                            <!--        <li><a href="#bachelor-of-arts">Bachelor of Arts</a></li>-->
                            <!--        <li><a href="#b.sc-nursing">B.Sc Nursing</a></li>-->
                            <!--    </ul>-->
                            <!--</div>-->
                        </div>
                    </div>
