                                                ...
                                                {{-- @if (field('student_college_status')->status == 1)
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" name="college_status" required>
                                                            ...
                                                            <option value="1"
                                                                @if (old('college_status') == 1) selected @endif>
                                                                {{ __('college_first') }}</option>
                                                            <option value="2"
                                                                @if (old('college_status') == 2) selected @endif>
                                    ...
                                    <fieldset class="row scheduler-border">
                                        ...
                                        {{-- <div class="form-group col-md-6 ">
                                            <label for="college_status">{{ 'College Status' }}
                                                <span>*</span></label>
                                            <select class="form-control college" name="college_status" id="college"
                                                required>
                                                <option value="">{{ __('select') }}</option>
                                ...
                                <content class="form-step">
                                    ...
                                    <fieldset class="row scheduler-border">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control autonumber" name="transfer_id"
                                                id="transfer_id" value="{{ old('transfer_id') }}" required>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="university_name">{{ __('field_university_name') }}
                                                <span>*</span></label>
                                            <input type="text" class="form-control" name="university_name"
                                                id="university_name" value="{{ old('university_name') }}" required>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(document).on('click', '#addField', function() {
                ...
                html +=
                    '<div class="form-group col-md-4"> <label for="marks" class="form-label">{{ __('field_mark') }} <span>*</span></label><input type="text" class="form-control autonumber" name="marks[]" id="marks" value="{{ old('marks') }}" data-v-max="999" data-v-min="0" required> <div class="invalid-feedback"> {{ __('required_field') }} {{ __('field_mark') }} </div> </div>';
                html +=
                    '<div class="form-group col-md-4"><button id="removeTField" type="button" class="btn btn-danger btn-filter"><i class="fas fa-trash-alt"></i> {{ __('btn_remove') }}</button></div>';
                html += '</div>';
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(document).on('click', '#addDocument', function() {
                ...
                html +=
                    '<div class="form-group col-md-4"><label for="t_titles" class="form-label">{{ __('field_title') }} <span>*</span></label><input type="text" class="form-control" name="titles[]" id="t_titles" value="{{ old('titles') }}" required><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_title') }}</div></div>';
                html +=
