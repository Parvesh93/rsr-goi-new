...
@keyframes pulse {
    ...
    70% {
        box-shadow: 0 0 0 12px rgba(75, 0, 130, 0);
    }
    100% {
...
.form-number2 {
    ...
    font-size: 18px;
    color: #2e003e;
    /* optional: dark purple college theme */
    padding-right: 20px; /* optional: some spacing from edge */
    margin-top:-15px;
}
.reg_no{
    color: red;
...
/*.recognition .affiliatio .address{*/
/*    color: black;*/
/*    font-weight: bold;*/
/*}*/
...
<div class="template-container" id="" style="width: 1000 ; height: 1000;">
  <div class="template-inner">
    <div class="animated-heading">
    Application Form Preview
  </div>
  <div class="container">
        <div class="form-number2"><span class="reg_no">Application No : </span>{{@$application->registration_no}}</div>
      <div class="header">
        <div class="logo-section">
          <img
            src="{{asset('uploads/setting/rsr_logo.png')}}"
            alt="RSR College Logo"
            class="college-logo"
          />
        </div>
     ...
     <div class="form-title">ADMISSION FORM</div>
      ...
      <div class="office-use-section">
        <h3 class="question-color o-bold" >For Office use Only</h3>
        <div class="office-fields">
          ...
          <div class="field"><span class="question-color">5. Roll No.:</span> _________________________</div>
...
<div class="form-row question-color give-space">
          ...
          <table class="edu-table">
            ...
            <tbody>
              <tr>
                ...
                <td><textarea  name="tenth_school" value="{{ @$application->high_school_name}}" required >{{ @$application->high_school_name}}</textarea></td>
                <!--<td><input type="text" name="tenth_school" value="{{ @$application->high_school_name}}" required /></td>-->
                <td><textarea  name="tenth_board" required value="{{ @$application->high_school_address}}" >{{ @$application->high_school_address}}</textarea></td>
                <!--<td><input type="text" name="tenth_address" required  value="{{ @$application->high_school_address}}"/></td>-->
                <td><textarea  name="tenth_year" value="{{ @$application->high_school_graduation_year}}" required >{{ @$application->high_school_graduation_year}}</textarea></td>
                <td><textarea type="text" name="tenth_total_marks" required value="{{ @$application->high_school_total_marks}}" >{{ @$application->high_school_total_marks}}</textarea></td>
                <td>
                  <textarea type="text" name="tenth_obtained_marks" required value="{{ @$application->high_school_marks_obtained}}">{{ @$application->high_school_marks_obtained}}</textarea>
                </td>
                <td><textarea type="text" name="tenth_percentage" value="{{ @$application->high_school_graduation_percentage}}" required >{{ @$application->high_school_graduation_percentage}}</textarea></td>
              </tr>
              <tr>
                <td class="bold-text">Intermediate (12th)</td>
               <td><textarea type="text" name="twelfth_school" value="{{ @$application->intermediate_name}}"  required >{{ @$application->intermediate_name}}</textarea></td>
                <td><textarea type="text" name="twelfth_board" required value="{{ @$application->intermediate_address}}">{{ @$application->intermediate_address}}</textarea></td>
                <!--<td><input type="text" name="twelfth_address" required value="{{ @$application->intermediate_address}}" /></td>-->
                <td><textarea type="text" name="twelfth_year" required  value="{{ @$application->intermediate_graduation_year}}" >{{ @$application->intermediate_graduation_year}}</textarea></td>
                <td>
                  <textarea type="text" name="twelfth_total_marks" required value="{{ @$application->intermediate_total_marks}}" >{{ @$application->intermediate_total_marks}}</textarea>
                </td>
                <td>
                  <textarea type="text" name="twelfth_obtained_marks" required value="{{ @$application->intermediate_marks_obtained}}" >{{ @$application->intermediate_marks_obtained}}</textarea>
                </td>
                <td>
                  <textarea type="text" name="twelfth_percentage" value="{{ @$application->inter_graduation_percentage}}" required >{{ @$application->inter_graduation_percentage}}</textarea>
                </td>
              </tr>
              <tr>
                <td class="bold-text">Graduation (UG) </td>
             <td><textarea type="text" name="graduation_college" value="{{ @$application->bach_college_name}}">{{ @$application->bach_college_name}}</textarea></td>
                <td><textarea type="text" name="graduation_university" value="{{@$application->bach_college_address}}" >{{ @$application->bach_college_address}}</textarea></td>
                <!--<td><input type="text" name="graduation_address" value="{{ @$application->bach_college_address}}"/></td>-->
                <td><textarea type="text" name="graduation_year" value="{{ @$application->bach_gradu_year}}">{{ @$application->bach_gradu_year}}</textarea></td>
                <td><textarea type="text" name="graduation_total_marks" value="{{@$application->bach_total_marks}}">{{@$application->bach_total_marks}}</textarea></td>
                <td><textarea type="text" name="graduation_obtained_marks" value="{{@$application->bach_marks_obtained}}">{{@$application->bach_marks_obtained}}</textarea></td>
                <td><textarea type="text" name="graduation_percentage" value="{{ @$application->bach_gradu_percentage}}">{{ @$application->bach_gradu_percentage}}</textarea></td>
              </tr>
              <tr>
                <td class="bold-text">Masters <br>(PG) </td>
                <td><textarea type="text" name="masters_college" value="{{ @$application->master_college_name}}" >{{ @$application->master_college_name}}</textarea></td>
                <td><textarea type="text" name="masters_university" value="{{@$application->master_college_address}}" >{{@$application->master_college_address}}</textarea></td>
                <!--<td><input type="text" name="masters_address" value="{{ @$application->master_college_address}}" /></td>-->
                <td><textarea type="text" name="masters_year" value="{{ @$application->master_gradu_year}}">{{ @$application->master_gradu_year}}</textarea></td>
                <td><textarea type="text" name="masters_total_marks" value="{{@$application->master_total_marks}}" >{{@$application->master_total_marks}}</textarea></td>
                <td><textarea type="text" name="masters_obtained_marks" value="{{@$application->master_marks_obtained}}" >{{@$application->master_marks_obtained}}</textarea></td>
                <td><textarea type="text" name="masters_percentage"value="{{ @$application->master_gradu_percentage}}" >{{ @$application->master_gradu_percentage}}</textarea></td>
              </tr>
            </tbody>
          </table>
  ...
  <div class="animated-box">
    @php
    $application_id = (!empty($application->id) && $application->id != 0) ? $application->id : 0;
   @endphp
    <div class="box"><a href="{{route('application.index')}}">Back To Application Form</a></div>
    <div class="box"><a href="{{ route('student.application.download', $application_id) }}" target="_blank">Download Application Form</a></div>
    <div class="box"><a href="{{ route('student.application.card', $application_id) }}" target="_blank" >Print Application Form</a></div>
</div>
