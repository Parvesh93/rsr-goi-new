                        ...
                        <form class="needs-validation" novalidate method="get" action="{{ route($route.'.index') }}">
                            <div class="row gx-2">
                                ...
                                {{-- <div class="form-group col-md-3">
                                    <label for="college_status">{{ 'College Status' }} <span>*</span></label>

                                    <input type="text" class="form-control" name="college_status" id="college_status" value="{{ $admission_college_id}}">
                                    <select class="form-control college" name="college_status" id="college" required>
                                        <option value="">{{ __('select') }}</option>
                                        $admission_college_id 
                                        <option value="1" @if($selected_college_id == 1 ) selected @endif>{{ __('college_first') }}</option>
                                        <option value="2" @if( $selected_college_id== 2 ) selected @endif>{{ __('college_second') }}</option>
                                ...
                                <div class="form-group col-md-2">
                                    <label for="person">Reference Person</label>
