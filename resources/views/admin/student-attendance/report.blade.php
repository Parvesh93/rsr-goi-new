                    ...
                    <div class="card-block">
                        ...
                        <div class="table-responsive">
                            <table class="table table-attendance table-striped table-hover table-bordered printable">
                                ...
                                <tbody>
                                  ...
                                  @endphp
                                    <tr>
                                        ...
                                        {{-- <td>
                                            @if( $row->student->admission_college == 1 )
                                            {{ __('college_first') }}
                                            @elseif( $row->student->admission_college == 2 )
                                            {{ __('college_second') }}
                                ...
                                <caption>{{ $cur_subject ?? '' }} - {{ date("F Y", strtotime($selected_year.'-'.$selected_month.'-01')) ?? '' }}</caption>
                            </table>
                        </div>
                        <!-- [ Data table ] end -->
                    </div>
