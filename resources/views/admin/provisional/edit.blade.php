                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="result">{{ 'Student Passing Division' }}
                                                    <span>*</span></label>
                                                <select class="form-control " name="result" id="result" required>
                                                    <option value="">{{ __('select') }}</option>
                                                    <option value={{$row->result }} @if ($row->result == "Pass") selected @endif>{{ "Pass" }}  </option>
                                                    <option value={{$row->result }} @if ($row->result == "Fail") selected @endif>{{ "Fail" }} </option>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="dob">{{ 'Date fo Issue' }} <span>*</span></label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="passing_date">{{ 'Passing Date' }} <span>*</span></label>
                                                <input type="date" class="form-control passing_date" name="passing_date"
                                                    id="passing_date" value="{{ $row->passing_date }}" required>

                                                <div class="invalid-feedback">
                                                    {{ __('required_field') }} {{ 'Passing Date' }}
                                                </div>
                                            </div>
