                                ...
                                <content class="form-step">
                                    ...
                                    <fieldset class="row scheduler-border">
                                        <legend>{{ __('field_academic_information') }}</legend>
                                         ...
                                         <div class="form-group col-md-4">
                                            <label for="registration_no">{{ __('field_stu_registration_no') }} <span>*</span></label>
                                         ...
                                         <div class="form-group col-md-4">
                                          ...
                                          <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="total_course_fees" id="total_course_fees"
                                                value="{{ $row->total_course_fees }}" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="refrence_person_name" id="refrence_person_name"
                                                value="{{$row->refrence_person_name}}" required>
                                      ...
                                      <fieldset class="row scheduler-border">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div id="inputFormFieldSecond" class="row">
                                                    ...
                                                    <div class="form-group col-md-4"><label for="refrence_ids" class="form-label">{{ __('field_refrence_id') }}</label><input type="text" class="form-control" name="refrence_ids[]" id="refrence_ids" value="{{$refrence->utr_no}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_refrence_id') }}</div></div>
                                                    
                                                    <div class="form-group col-md-4"><label for="ref_amounts" class="form-label">{{ __('field_ref_amount') }} </label><input type="text" class="form-control ref_amounts" name="ref_amounts[]" id="ref_amounts" value="{{$refrence->ref_amount}}" ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_ref_amount') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="ref_dates" class="form-label">{{ __('field_ref_date') }} </label><input type="date" class="form-control date" name="ref_dates[]" id="ref_dates" value="{{$refrence->ref_date}}"  ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_ref_date') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="ref_names" class="form-label">{{ __('field_ref_name') }} </label><input type="text" class="form-control" name="ref_names[]" id="ref_names" value="{{$refrence->ref_name}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_ref_name') }}</div></div>
                                                </div>
                                    ...
                                    <fieldset class="row scheduler-border">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div id="inputFormFieldcCash" class="row">
                                                    <div class="form-group col-md-4"><label for="cash_ids" class="form-label">{{ __('field_cash_id') }}</label><input type="text" class="form-control" name="cash_ids[]" id="cash_ids" value="{{$cash->utr_no}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_cash_id') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="cash_amounts" class="form-label">{{ __('field_cash_amount') }} </label><input type="text" class="form-control cash_amounts" name="cash_amounts[]" id="cash_amounts" value="{{$cash->cash_amount}}" ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_cash_amount') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="cash_dates" class="form-label">{{ __('field_cash_date') }} </label><input type="date" class="form-control date" name="cash_dates[]" id="cash_dates" value="{{$cash->cash_date}}" ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_cash_date') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="cash_names" class="form-label">{{ __('field_cash_name') }} </label><input type="text" class="form-control" name="cash_names[]" id="cash_names" value="{{$cash->cash_name}}"  ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_cash_name') }}</div></div>
                                     ...
                                     <fieldset class="row scheduler-border">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div id="inputFormFieldBank" class="row">
                                                    <div class="form-group col-md-4"><label for="bank_ids" class="form-label">{{ __('field_bank_id') }}</label><input type="text" class="form-control" name="bank_ids[]" id="bank_ids" value="{{$bank->receipt_no}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_id') }}</div></div>
                                                    
                                                     <div class="form-group col-md-4"><label for="utr_nos" class="form-label">{{ __('field_bank_utr_no') }} </label><input type="text" class="form-control utr_nos" name="utr_nos[]" id="utr_nos" value="{{$bank->utr_no}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_utr_no') }}</div></div>
                                                    
                                                    <div class="form-group col-md-4"><label for="bank_amounts" class="form-label">{{ __('field_bank_amount') }} </label><input type="text" class="form-control bank_amounts" name="bank_amounts[]" id="bank_amounts" value="{{$bank->bank_amount}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_amount') }}</div></div>
                                                    
                                                    <div class="form-group col-md-4"><label for="bank_dates" class="form-label">{{ __('field_bank_date') }} </label><input type="date" class="form-control date" name="bank_dates[]" id="bank_dates" value="{{$bank->bank_date}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_date') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="bank_names" class="form-label">{{ __('field_bank_names') }} </label><input type="text" class="form-control" name="bank_names[]" id="bank_names" value="{{$bank->bank_name}}"  ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_names') }}</div></div>
                                                </div>
                                                @endforeach
                                 ...
                                 <fieldset class="row scheduler-border">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div id="inputFormFieldDeduction" class="row">
                                                    <div class="form-group col-md-4"><label for="deduction_ids" class="form-label">{{ __('field_deduction_id') }}</label><input type="text" class="form-control" name="deduction_ids[]" id="deduction_ids" value="{{$deduction->utr_no}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_deduction_id') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="deduction_amounts" class="form-label">{{ __('field_deduction_amount') }} </label><input type="text" class="form-control deduction_amounts" name="deduction_amounts[]" id="deduction_amounts" value="{{$deduction->deduction_amount}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_bank_amount') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="deduction_dates" class="form-label">{{ __('field_deduction_date') }} </label><input type="date" class="form-control date" name="deduction_dates[]" id="deduction_dates" value="{{$deduction->deduction_date}}"><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_deduction_date') }}</div></div>
                                                    <div class="form-group col-md-4"><label for="deduction_names" class="form-label">{{ __('field_deduction_names') }} </label><input type="text" class="form-control" name="deduction_names[]" id="deduction_names" value="{{$deduction->deduction_name}}"  ><div class="invalid-feedback">{{ __('required_field') }} {{ __('field_deduction_names') }}</div></div>
                                                </div>
                                                @endforeach
