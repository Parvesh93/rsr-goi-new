                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <a href="{{ route('student.reset') }}" hidden class="btn btn-primary"><i
                                    class="fas fa-plus"></i>
                                Reset</a>

                            <a href="{{ route($route . '.cancel') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i>
                                {{ __('btn_refresh') }}</a>
                                        ...
                                        <tbody>
                                            ...
                                            @endcan
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route($route . '.download', ['id' => $row->id]) }}"
