        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-blue bitcoin-wallet">
                      <a href="{{route('admin.pending.check.st')}}"> <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-blue bitcoin-wallet">
                     <a href="{{route('admin.active.test.act')}}"> <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-blue bitcoin-wallet">
                    <a href="{{route('admin.active.staff')}}">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-blue bitcoin-wallet">
                    <a href="{{route('admin.active.book')}}">
                      <div class="card-block">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card theme-bg bitcoin-wallet">
                    <a href="{{route('admin.active.visitor')}}">
                       <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card theme-bg bitcoin-wallet">
                    <a href="{{route('admin.active.phone')}}">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card theme-bg bitcoin-wallet">
                <a href="{{route('admin.active.enquiry')}}">
                    <div class="card-block">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card theme-bg bitcoin-wallet">
                    <a href="{{route('admin.active.postal')}}">
                     <div class="card-block">
