            ...
            <div class="space-update1">
                ...
                <div class="border-color">
                    ...
                    <div class="certificate ">
                         <div class="left ">
                                <span class="label change-font-heading">SL.No.: </span><span  class="label change-font-heading"> &nbsp;&nbsp;&nbsp;{{ $row->serial_no }}</span> 
                            </div>
                        ...
                        <p class="change-font ">
                            ...
                            Campus,Patna in the Month of <span class="bold change-font-heading-imp">{{ \Carbon\Carbon::parse($row->date)->format('F Y') }}.</span>
                        ...
                        <p class="remove-space"><span class="change-font">Result</span> -</p>
