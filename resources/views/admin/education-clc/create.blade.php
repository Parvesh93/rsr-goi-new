                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="">
                            ...
                            <form id="" class="" action="{{ route($route . '.store') }}" method="post">
                                @csrf
                                        ...
                                        <fieldset class="row scheduler-border">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="registration_no"
                                                    id="registration_no" value="{{ old('registration_no') }}" required>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="role_code">{{ 'Roll Code' }}
                                                    <span>*</span></label>

                                                <input type="text" class="form-control" name="role_code" id="role_code"
                                                    value="{{ old('role_code') }}" required>

                                                <div class="invalid-feedback">
                                                    {{ __('required_field') }} {{ 'Roll Code' }}
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="exam_role_no">{{ 'Exam Roll No' }}
                                                    <span>*</span></label>

                                                <input type="text" class="form-control" name="exam_role_no" id="exam_role_no"
                                                    value="{{ old('exam_role_no') }}" required>

                                                <div class="invalid-feedback">
                                                    {{ __('required_field') }} {{ 'Exam Roll No' }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="college_name"
                                                    id="college_name" value="{{ old('college_name') }}" required>
                                            ...
                                            <div class="form-group col-md-12 d-flex justify-content-end">
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="fas fa-save"></i> {{ __('btn_save') }}</button>
