            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="title">{{ __('field_college') }} <span>*</span></label>
                            <input type="text" class="form-control" name="college" id="college" value="{{ isset($row->college)?$row->college:'' }}" required>
  
                            <div class="invalid-feedback">
                              {{ __('required_field') }} {{ __('field_college') }}
                            </div>
                        </div>
