                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="sub_title" id="sub_title" rows="4">{{ $row->sub_title }}</textarea>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="section" id="section" value="{{$row->section}}" required>
                        ...
                        <div class="form-group col-md-6">
                            <label for="attach">{{ __('field_thumbnail') }}: <span>{{ __('image_size', ['height' => 850, 'width' => 1920]) }}</span></label>
