...
@media print {
    .printable {
        border: 4px solid #76037c !important;
        padding: 1px;
        margin: 10px;
    }
...
<div class="template-container printable"  >
  ...
  <label>Nationality:</label>
     <input type="text" name="" value="{{ @$application->nationality }}" disabled />
       ...
       <div style="width: 100%; text-align: right; margin-top: 30px; margin-bottom:-10px">
    <div style="display: inline-block;padding-top:30px; font-weight:bold; font-size:20px; color:black; width: 200px;">
        Admission Incharge
    </div>
</div>
    </div>
