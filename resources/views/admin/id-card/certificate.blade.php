            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ __('field_certificate') }} {{ __('list') }}</h5>
                    </div>
                    <div class="card-block">
                        <form class="needs-validation" novalidate method="get" action="{{ route('admin.student.certificate') }}">
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="student_regi" id="student_regi" value="{{ $selected_student_regi }}">
                                  ...
                                  @endphp
                                    <tr>
                                        ...
                                        <td>
                                            @can($access.'-card')
                                            @if(isset($print))
                                            <a href="#" class="btn btn-icon btn-dark btn-sm" onclick="PopupWin('{{ route('admin.student.cls', ['id' => $row->id]) }}', '{{ $title }}', 1000, 600);">
