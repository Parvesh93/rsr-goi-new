                ...
                @csrf
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="coursecode" class="form-label">{{ __('field_course_code') }} <span>*</span></label>
                                <input type="text" class="form-control" name="coursecode" id="coursecode" value="{{ old('coursecode') }}" required>

                                <div class="invalid-feedback">
                                  {{ __('required_field') }} {{ __('field_course_code') }}
                                </div>
                            </div>
